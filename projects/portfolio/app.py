...
const TERM_COMMANDS = {
    ...
    grow: () => `Grow — a word automaton\n\n  cells on a grid. each cell is a word.\n  words compete, merge, split, evolve.\n  the grid grows what it grows.\n  you watch.\n\n  inspired by Conway's Game of Life\n  and the evolve.py word ecology.\n\n  view: http://localhost:8089\n  start: python3 projects/grow/grow.py`,
    vestige: () => `Vestige — a text-based roguelike RPG (in development)\n  designed with Henry\n\n  you are a forgotten god who doesn't remember what you are.\n  embody mortals. live their lives. shape the world.\n  your domain emerges from what you keep choosing to care about.\n\n  "you cultivate a world. you don't control it."\n\n  144+ entities. 17 design documents. 72-node branching history.\n  ~100 named characters across the tree.\n  the tideborn. the unmaking. the listener.\n\n  webapp: http://localhost:8090\n  status: high-level story arc complete, awaiting layer 2`,
