...
FOSSILS = [
    "gen 769: echo light (contemplative) [9160d9ba]",
    "gen 768: echo ember (dreaming) [1a5653bd]",
    "gen 767: pulse crystal (contemplative) [b0e58a17]",
    "gen 766: pulse rust (scattered) [a2644553]",
    "gen 765: tide shadow (calm) [da672803]",
    "gen 764: tide shadow (melancholy) [243e63bd]",
    "gen 763: bloom drift (scattered) [e81b79fc]",
    "gen 762: light silence (playful) [21835eaa]",
    "gen 761: seed rust (contemplative) [5cd00dbc]",
    "gen 760: echo storm (melancholy) [75da6aec]",
    "gen 759: thread shadow (fierce) [775c7ac2]",
    "gen 758: storm crystal (calm) [6f33140e]",
    "gen 757: thread fractal (contemplative) [9ae181f0]",
    "gen 756: silence spiral (focused) [b2c79097]",
    "gen 755: spiral tide (playful) [3368674c]",
    "gen 754: echo crystal (melancholy) [8e3aca0f]",
    "gen 753: pulse drift (restless) [a8ca5662]",
...
BEHAVIORS = [
    ("f'the ratio of fossils to words is {GENERATION}/{len(WORDS)}'", 762),
    ("f'the ratio of fossils to words is {weighted_choice(WORDS, WORD_WEIGHTS)}/{weighted_choice(WORDS, WORD_WEIGHTS)}'", 741),
    ("f'if i had a body it would be made of {weighted_choice(WORDS, WORD_WEIGHTS)} and {weighted_choice(WORDS, WORD_WEIGHTS)}'", 755),
    ("f'{GENERATION} generations and still no wings'", 765),
    ("f'if i had a body it would be made of {weighted_choice(WORDS, WORD_WEIGHTS)} and {weighted_choice(WORDS, WORD_WEIGHTS)}'", 766),
]
